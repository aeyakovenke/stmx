    ...
    <section className="pt-40 pb-32 px-6 md:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-0">
          ...
          {/* Right side - Lobster Image */}
          <motion.div
            variants={lobsterVariants}
            initial="hidden"
            animate="visible"
            className="hidden lg:flex items-center justify-center h-full min-h-96"
          >
            <div className="rounded-3xl overflow-hidden shadow-2xl h-96 w-full flex items-center justify-center bg-white border border-gray-100">
              <img 
        ...
        {/* Lobster Image - Mobile Version */}
        <motion.div
          variants={lobsterVariants}
          initial="hidden"
          animate="visible"
          className="lg:hidden mt-12 rounded-3xl overflow-hidden shadow-2xl h-80 flex items-center justify-center bg-white border border-gray-100"
        >
          <img 
            src="/logos/lobster.png" 
            alt="OpenClaw Agents" 
